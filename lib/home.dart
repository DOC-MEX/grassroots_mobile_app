...
class _HomePageState extends State<HomePage> {
  ...
  final backendRequests Backend = backendRequests();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //      right: 10.0, bottom: 3.0), // Add some right and bottom padding
        //  child: ElevatedButton(
        //    onPressed: () {
        //      if (isCameraOpen) {
        //        setState(() {
        ...
        //        borderRadius:
        //            BorderRadius.circular(5.0), // Slightly rounded corners
        //      ),
        //      padding: EdgeInsets.symmetric(
        //          horizontal: 16.0,
        //          vertical:
        //              12.0), // Padding around the icon for better appearance
        //    ),
        //    child: Icon(isCameraOpen ? Icons.close : Icons.camera),
        //  ),
        // ),
        floatingActionButton:
            null //. Comment out and replace camera button code with this line for temporarily disabling camera button ###
        );
  }
}
